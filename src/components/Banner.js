...
export const Banner = () => {
  ...
  const toRotate = [ "Web Designer", "Software Developer", "Full Stack Developer" ];
  const period = 2000;
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Josh`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Web Designer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>Hello! Welcome to my website portfolio. My name is Jeshua Cabanillas Blanco, better known as <b>Josh</b>. I'm a Full Stack Web Developer from Lima, Perú.</p>
